...
export const CarverSourceImportSection: React.FC = () => {
  ...
  const handleImportRecords = async () => {
    ...
    try {
      console.log('🚀 Starting direct import to carver_source table...');
    ...
    <Card className="bg-white/10 backdrop-blur-md border-white/20">
      <CardHeader>
        ...
        <CardDescription className="text-slate-300">
          Importera kopplingar mellan carver-inscription och källor från MySQL-export
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Textarea
            ...
            placeholder="Klistra in MySQL INSERT statement för carver_source-tabellen här..."
