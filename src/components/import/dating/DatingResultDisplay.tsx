...
import { DatingImportResult } from './types';

interface DatingResultDisplayProps {
  importResult: DatingImportResult | null;
}

export const DatingResultDisplay: React.FC<DatingResultDisplayProps> = ({
  importResult
}) => {
