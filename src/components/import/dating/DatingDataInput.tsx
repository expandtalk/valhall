...
interface DatingDataInputProps {
  sqlData: string;
  setSqlData: (data: string) => void;
  isImporting: boolean;
}

export const DatingDataInput: React.FC<DatingDataInputProps> = ({
  sqlData,
  setSqlData,
  isImporting
}) => {
  return (
    <div>
      ...
      <Textarea
        ...
        placeholder="Klistra in MySQL INSERT statement för dating-tabellen här..."
