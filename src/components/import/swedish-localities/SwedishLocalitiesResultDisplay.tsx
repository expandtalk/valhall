...
interface SwedishLocalitiesResultDisplayProps {
  importResult: ImportResult;
  onClose: () => void;
}

export const SwedishLocalitiesResultDisplay: React.FC<SwedishLocalitiesResultDisplayProps> = ({ importResult, onClose }) => (
