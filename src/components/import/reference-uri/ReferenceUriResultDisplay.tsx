...
import { ReferenceUriImportResult } from './types';

interface ReferenceUriResultDisplayProps {
  importResult: ReferenceUriImportResult | null;
}

export const ReferenceUriResultDisplay: React.FC<ReferenceUriResultDisplayProps> = ({ importResult }) => {
