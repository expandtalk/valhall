...
interface SignumInscriptionResultDisplayProps {
  importResult: { success: boolean; message: string; details?: string } | null;
  onClose: () => void;
}

export const SignumInscriptionResultDisplay: React.FC<SignumInscriptionResultDisplayProps> = ({ importResult, onClose }) => {
