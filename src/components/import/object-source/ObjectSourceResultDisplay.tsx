...
import { ObjectSourceImportResult } from './types';
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { CheckCircle, XCircle } from 'lucide-react';
import { ScrollArea } from '@/components/ui/scroll-area';

interface ObjectSourceResultDisplayProps {
  importResult: ObjectSourceImportResult | null;
}

export const ObjectSourceResultDisplay: React.FC<ObjectSourceResultDisplayProps> = ({ importResult }) => {
