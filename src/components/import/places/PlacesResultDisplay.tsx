...
interface PlacesResultDisplayProps {
  importResults: ImportResults;
  onClose: () => void;
}

export const PlacesResultDisplay: React.FC<PlacesResultDisplayProps> = ({ importResults, onClose }) => (
  <div className="space-y-4">
    <h3 className="text-lg font-semibold text-white">Importresultat</h3>
    <div className="flex items-center gap-2 text-green-400">
      <CheckCircle className="h-5 w-5" />
      <span>{importResults.success} platser importerades.</span>
    </div>
