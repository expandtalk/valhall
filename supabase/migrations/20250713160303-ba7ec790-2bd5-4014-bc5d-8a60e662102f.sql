...
-- Isala, Svärdsjö
('Isala', 'u kaahlir', NULL, NULL, 'ca 1520 eller senare', 'Isala', 'Svärdsjö', 'Svärdsjö', 'Dalarna', 'Dalarna', 'Sverige', 'Byggnadsinskrift', 'Trä', POINT(15.943672, 60.770426), 'Osäker datering', 'Rundata', 'Skuren i fjärde stocken nedifrån, ca 15 cm lång', 'Kungsladan i Isala ska vara en av de platser Gustav Vasa besökte när han flydde undan danskarna vintern 1520. Berättelserna är dock först upptecknade 1667 och bör tas med försiktighet. Risk att inskriften är betydligt yngre.'),
