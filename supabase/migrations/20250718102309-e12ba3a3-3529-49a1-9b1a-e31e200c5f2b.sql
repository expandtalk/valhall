...
('Birka', '(17.5447, 59.3347)', 'trading_post', 750, 975, 'Sweden', 'Mälaren', 'Handelsstad på Björkö i Mälaren', 'Sveriges första stad och viktigaste handelsplats under vikingatiden', 'abandoned', true),
('Gamla Uppsala', '(17.6312, 59.8986)', 'religious_center', 500, 1090, 'Sweden', 'Uppland', 'Centrum för nordisk religion och kunglighet', 'Viktigaste religiösa och politiska centrum i forntida Sverige', 'evolved', false),
...
('Visby', '(18.2948, 57.6348)', 'trading_post', 1000, 1600, 'Sweden', 'Gotland', 'Medeltida hansastad', 'Viktigaste handelsstad i Östersjön under medeltiden', 'evolved', true),

-- Denmark
('Hedeby', '(9.5650, 54.4911)', 'trading_post', 700, 1100, 'Denmark', 'Schleswig', 'Nordens viktigaste handelsstad', 'Viktigaste handelsknutpunkt mellan Östersjön och Nordsjön', 'abandoned', true),
...
('Ribe', '(8.7613, 55.3265)', 'trading_post', 700, 1500, 'Denmark', 'Jutland', 'En av Skandinaviens äldsta städer', 'Viktig handelsplats och tidig kristet centrum', 'evolved', false),
...
('Borg', '(13.7892, 68.2472)', 'settlement', 500, 950, 'Norway', 'Lofoten', 'Hövdingasäte i Lofoten', 'Viktigt politiskt centrum i nord', 'archaeological', false),
...
unesco_site = EXCLUDED.unesco_site,
updated_at = now();