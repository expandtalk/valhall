...
-- Including names from carvers, historical kings, and runic inscriptions

-- First, let's add more male names with proper etymology
INSERT INTO viking_names (name, gender, meaning, etymology, historical_info, frequency, regions) VALUES
